...
We also need to remove the initialDeploymentSeconds from the liveness and readiness configurations as we now want them to start as soon as the startUpprobe has completed. If we dodn;t it woudl still wait for the change.
